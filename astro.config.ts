...
// Using a default localhost URL for the functional copy.
// The original used process.env.DOMAIN_NAME or process.env.VERCEL_URL.
// You might want to configure this properly for deployment later.
const siteUrl = 'http://localhost:4321'

// https://astro.build/config
export default defineConfig({
  // Set a default site URL for local development
  site: siteUrl,
  devToolbar: {
    enabled: false, // Keep dev toolbar disabled as in original
  },
  experimental: {
    svg: true,
  },
